...
public static class Reporter {
    ...
    public static void ReportQuestionDone(QuestionMetric questionMetric, string chatId, string questionName) {
        _log.Information("Save question metric {@ChatInfo} {@questionMetric} {@questionName}",
            new { ChatInfo = chatId }, questionMetric, questionName);
    ...
    public static void ReportExamPassed(long? userTelegramId, DateTime started, int questionsCount,
        int questionsPassed) {
