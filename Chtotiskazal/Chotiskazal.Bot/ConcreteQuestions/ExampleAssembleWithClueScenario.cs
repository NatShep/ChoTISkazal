...
public class ExampleAssembleWithClueScenario : IQuestionScenario {
    ...
    public async Task<QuestionResult> Pass(ChatRoom chat, UserWordModel word, UserWordModel[] examList) {
        ...
        return await AssemblePhraseScenarioHelper.AssemblePhrase(chat, targetPhrase.OriginPhrase, targetPhrase.TranslatedPhrase);
    }
}