...
public class EngWriteMissingLettersLogic : IQuestionLogic {
    private readonly StarredHardness _hardness;

    public EngWriteMissingLettersLogic(StarredHardness hardness) {
        _hardness = hardness;
    }
    ...
    public async Task<QuestionResult> Pass(ChatRoom chat, UserWordModel word, UserWordModel[] examList) {
        ...
        var (result, entry) = await QuestionLogicHelper.GetRussianUserInputOrIDontKnow(chat, msg);
