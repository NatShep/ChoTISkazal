...
namespace Chotiskazal.Bot.InterfaceLang
{
    public class EnglishTexts : IInterfaceTexts
    {
        ...
        public string defaultFailedString { get; }= "Noo...";
        public string defaultPassedString { get; }= "It's right!";
        public string defaultIgnoredString { get; }= "So so ...";

        public string defaultHideousFailedString { get; }= "Last answer was wrong";
        public string defaultHideousPassedString { get; }= "Last answer was right";
        public string defaultHideousIgnoredString { get; }= "Not really";
