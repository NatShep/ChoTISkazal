...
namespace Chotiskazal.ConsoleTesting.Services
{
    public class ExamService
    {
        ...
        public void UpdateAgingAndRandomize(int i) => _examsAndMetricService.UpdateAgingAndRandomize(i);
        ...
        public void RegistrateSuccess(int metricId) => _examsAndMetricService.RegistrateSuccess(metricId);
       
        public void RegistrateFailure(int metricId) => _examsAndMetricService.RegistrateFailure(metricId);
