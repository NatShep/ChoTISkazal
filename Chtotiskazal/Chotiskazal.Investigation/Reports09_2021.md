...
Отсюда можно понять ранжировку - для каких вопросов уровень сложности слишком простой, а для каких - слишком сложный. Однако некоторые вопросы подразумевают дисперсию. Они могут быть требовательны к опечаткам или не очень понятны пользователю. Изучим детальнее это
...
1) Данных пока мало. Нужно где то в 4 раза больше

2) Нужно поднять сложность:
```
